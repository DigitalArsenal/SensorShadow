...
class SensorShadow {
  ...
  constructor(viewer, options = {}) {
    ...
    if (
      ...
      throw new DeveloperError(
        "Expected options.cameraPosition to have a .getValue method or be an instance of Cartesian3."
      );
    }

    if (
      typeof options.viewPosition.getValue !== "function" &&
      !(options.viewPosition instanceof Cartesian3)
    ) {
      throw new DeveloperError(
        "Expected options.viewPosition to have a .getValue method or be an instance of Cartesian3."
      );
    }
  ...
  get _getVectors() {
    let positionVector =
      this.cameraPosition?.getValue(this.viewer.clock.currentTime) ||
      new Cartesian3();
    let viewVector =
      this.viewPosition?.getValue(this.viewer.clock.currentTime) ||
      new Cartesian3();
      ...
      new PostProcessStage({
        ...
        uniforms: {
          ...
          viewPosition_WC: function () {
            return (
              SensorShadow.viewPosition?.getValue(
